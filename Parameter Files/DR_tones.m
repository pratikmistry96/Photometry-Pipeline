...
%
%% General Parameters
params.dsType = 3; % 1 = Bin Summing; 2 = Bin Averaging; 3 = Traditional (NOT RECOMMENDED)
...
%% Reward and Lick Alignment Parameters
params.rew.timeBefore = -10;
params.rew.timeAfter = 5;
params.lick.timeBefore = -10;
params.lick.timeAfter = 10;
%% Peak Analysis
